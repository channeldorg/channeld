...
type TestRepChannelData struct {
	...
	CharacterStates        map[uint32]*unrealpb.CharacterState        `protobuf:"bytes,2,rep,name=characterStates,proto3" json:"characterStates,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	PlayerStates           map[uint32]*unrealpb.PlayerState           `protobuf:"bytes,3,rep,name=playerStates,proto3" json:"playerStates,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	ControllerStates       map[uint32]*unrealpb.ControllerState       `protobuf:"bytes,4,rep,name=controllerStates,proto3" json:"controllerStates,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	PlayerControllerStates map[uint32]*unrealpb.PlayerControllerState `protobuf:"bytes,5,rep,name=playerControllerStates,proto3" json:"playerControllerStates,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	GameState              *unrealpb.GameStateBase                    `protobuf:"bytes,6,opt,name=gameState,proto3" json:"gameState,omitempty"`
}
...
var file_tps_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x95, 0x08, 0x0a, 0x12, 0x54, 0x65, 0x73, 0x74,
	0x52, 0x65, 0x70, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x12, 0x67,
	0x0a, 0x14, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74,
	0x53, 0x74, 0x61, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x74,
	...
	0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x73, 0x12, 0x58, 0x0a, 0x0f, 0x63, 0x68, 0x61, 0x72, 0x61,
	0x63, 0x74, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	...
	0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x74, 0x70, 0x73, 0x70, 0x62, 0x2e,
	...
	0x53, 0x74, 0x61, 0x74, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x74,
	0x70, 0x73, 0x70, 0x62, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x70, 0x43, 0x68, 0x61, 0x6e,
	...
	0x6c, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x73, 0x12, 0x35,
	0x0a, 0x09, 0x67, 0x61, 0x6d, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28,
	...
	0x53, 0x74, 0x61, 0x74, 0x65, 0x1a, 0x66, 0x0a, 0x19, 0x53, 0x63, 0x65, 0x6e, 0x65, 0x43, 0x6f,
...
var file_tps_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_tps_proto_goTypes = []interface{}{
	...
	(*unrealpb.GameStateBase)(nil),         // 6: unrealpb.GameStateBase
	(*unrealpb.SceneComponentState)(nil),   // 7: unrealpb.SceneComponentState
	(*unrealpb.CharacterState)(nil),        // 8: unrealpb.CharacterState
	(*unrealpb.PlayerState)(nil),           // 9: unrealpb.PlayerState
	(*unrealpb.ControllerState)(nil),       // 10: unrealpb.ControllerState
	(*unrealpb.PlayerControllerState)(nil), // 11: unrealpb.PlayerControllerState
}
var file_tps_proto_depIdxs = []int32{
	...
	2,  // 1: tpspb.TestRepChannelData.characterStates:type_name -> tpspb.TestRepChannelData.CharacterStatesEntry
	3,  // 2: tpspb.TestRepChannelData.playerStates:type_name -> tpspb.TestRepChannelData.PlayerStatesEntry
	4,  // 3: tpspb.TestRepChannelData.controllerStates:type_name -> tpspb.TestRepChannelData.ControllerStatesEntry
	5,  // 4: tpspb.TestRepChannelData.playerControllerStates:type_name -> tpspb.TestRepChannelData.PlayerControllerStatesEntry
	6,  // 5: tpspb.TestRepChannelData.gameState:type_name -> unrealpb.GameStateBase
	7,  // 6: tpspb.TestRepChannelData.SceneComponentStatesEntry.value:type_name -> unrealpb.SceneComponentState
	8,  // 7: tpspb.TestRepChannelData.CharacterStatesEntry.value:type_name -> unrealpb.CharacterState
	9,  // 8: tpspb.TestRepChannelData.PlayerStatesEntry.value:type_name -> unrealpb.PlayerState
	10, // 9: tpspb.TestRepChannelData.ControllerStatesEntry.value:type_name -> unrealpb.ControllerState
	11, // 10: tpspb.TestRepChannelData.PlayerControllerStatesEntry.value:type_name -> unrealpb.PlayerControllerState
